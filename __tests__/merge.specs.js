...
const SOURCE_KEY = 'redis-ts:merge:src1';
const SOURCE_KEY2 = 'redis-ts:merge:src2';
const DEST_KEY = 'redis-ts:merge:dest';
...
describe('merge', () => {
  ...
  function mergeTs(first, second, opts) {
    ...
    return timestamps.reduce((res, ts) => {
